...
| Migration | Tabela | Descrição |
|-----------|--------|-----------|
| `2021_10_31_171917_create_pei_tab_pei_table.php` | `strategic_planning.tab_pei` | Ciclos de planejamento (ano início/fim) |
| `2021_11_01_212118_create_pei_tab_missao_visao_valores_table.php` | `strategic_planning.tab_missao_visao_valores` | Missão e Visão |
| `2024_06_18_114518_create_pei_tab_valores_table.php` | `strategic_planning.tab_valores` | Valores organizacionais (múltiplos) |

#### 3.2 Balanced Scorecard (BSC)

| Migration | Tabela | Descrição |
|-----------|--------|-----------|
| `2021_11_08_185623_create_pei_tab_perspectiva_table.php` | `strategic_planning.tab_perspectiva` | 4 perspectivas BSC |
| `2021_11_09_094804_create_pei_tab_objetivo_estrategico_table.php` | `strategic_planning.tab_objetivo_estrategico` | Objetivos estratégicos |
| `2021_11_09_095359_create_pei_tab_nivel_hierarquico_table.php` | `strategic_planning.tab_nivel_hierarquico` | 100 níveis hierárquicos |
| `2024_06_21_172717_create_pei_tab_futuro_almejado_objetivo_estrategico_table.php` | `strategic_planning.tab_futuro_almejado_objetivo_estrategico` | Futuro almejado por objetivo |

#### 3.3 Planos de Ação e Entregas

| Migration | Tabela | Descrição |
|-----------|--------|-----------|
| `2021_11_14_221355_create_pei_tab_tipo_execucao_table.php` | `strategic_planning.tab_tipo_execucao` | 3 tipos: Ação, Iniciativa, Projeto |
| `2021_11_14_221613_create_pei_tab_plano_de_acao_table.php` | `strategic_planning.tab_plano_de_acao` | Planos de ação com orçamento, status, PPA/LOA |
| `2024_11_15_215604_create_pei_tab_entregas_table.php` | `strategic_planning.tab_entregas` | Entregas dos planos (com hierarquia) |

#### 3.4 Indicadores (KPIs)

| Migration | Tabela | Descrição |
|-----------|--------|-----------|
| `2021_12_28_232711_create_pei_tab_indicador_table.php` | `strategic_planning.tab_indicador` | Indicadores de desempenho |
| `2021_12_28_234715_create_pei_tab_evolucao_indicador_table.php` | `strategic_planning.tab_evolucao_indicador` | Evolução mensal (previsto vs. realizado) |
| `2021_12_28_235603_create_pei_tab_linha_base_indicador_table.php` | `strategic_planning.tab_linha_base_indicador` | Linha de base por ano |
| `2022_01_03_105544_create_pei_tab_meta_por_ano_table.php` | `strategic_planning.tab_meta_por_ano` | Metas anuais |
| `2022_01_26_152500_create_pei_tab_grau_satisfacao_table.php` | `strategic_planning.tab_grau_satisfcao` | Farol de desempenho (cores, faixas) |
| `2022_02_07_100332_create_pei_tab_arquivos_table.php` | `strategic_planning.tab_arquivos` | Anexos de evidências |
| `2024_07_01_150643_create_pei_rel_indicador_objetivo_estrategico_organizacao_table.php` | `strategic_planning.rel_indicador_objetivo_estrategico_organizacao` | Indicador ↔ Organização |

#### 3.5 Cadeia de Valor

| Migration | Tabela | Descrição |
|-----------|--------|-----------|
| `2023_01_10_164526_create_pei_tab_atividade_cadeia_valor_table.php` | `strategic_planning.tab_atividade_cadeia_valor` | Atividades da cadeia de valor |
| `2023_01_11_162049_create_pei_tab_processos_atividade_cadeia_valor_table.php` | `strategic_planning.tab_processos_atividade_cadeia_valor` | Processos (Entrada → Transformação → Saída) |
...
| Migration | Tabela | Descrição |
|-----------|--------|-----------|
| `2025_12_24_100000_create_pei_tab_risco_table.php` | `strategic_planning.tab_risco` | Riscos estratégicos (Probabilidade × Impacto = Nível 1-25) |
| `2025_12_24_100001_create_pei_tab_risco_objetivo_table.php` | `strategic_planning.tab_risco_objetivo` | Riscos ↔ Objetivos Estratégicos (pivot) |
| `2025_12_24_100002_create_pei_tab_risco_mitigacao_table.php` | `strategic_planning.tab_risco_mitigacao` | Planos de mitigação (Prevenir, Reduzir, Transferir, Aceitar) |
| `2025_12_24_100003_create_pei_tab_risco_ocorrencia_table.php` | `strategic_planning.tab_risco_ocorrencia` | Histórico de ocorrências de riscos |
...
3. **Schema PEI:**
   - Todas as tabelas de planejamento estratégico estão no schema `strategic_planning.`
