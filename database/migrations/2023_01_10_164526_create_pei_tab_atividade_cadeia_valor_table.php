...
return new class extends Migration
{
    ...
    {
        Schema::create('strategic_planning.tab_atividade_cadeia_valor', function (Blueprint $table) {
    ...
    {
        DB::statement('DROP TABLE IF EXISTS "strategic_planning"."tab_atividade_cadeia_valor" CASCADE');
    }
};
