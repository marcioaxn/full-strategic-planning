...
return new class extends Migration
{
    ...
    {
        Schema::create('pei.jobs', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('pei.job_batches', function (Blueprint $table) {
        ...
        Schema::create('pei.failed_jobs', function (Blueprint $table) {
            $table->id();
